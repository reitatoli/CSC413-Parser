...
public class PrintVisitor extends ASTVisitor {
     ...
     * @param t is the tree to print - print the information in the node at the
     * root (e.g. decoration) and its kids indented appropriately
     */
    ...
    public Object visitFloatTree(AST t) {
        print("Float: " + ((FloatTree) t).getSymbol().toString(), t);
        return null;
    }
